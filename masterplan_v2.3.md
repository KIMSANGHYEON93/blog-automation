...
[Phase 5: 운영 안정화]
[ ] 5.1 2일 연속 자동 실행 성공
[ ] 5.2 로그 점검 체계 구축 (일일 → 주 1회)
[ ] 5.3 Google Search Console 등록 + sitemap 제출
[ ] 5.4 Google Analytics 4 설치
[ ] 5.5 네이버 서치어드바이저 등록
[ ] 5.6 첫 5건 수동 색인 요청
[ ] 5.7 성과 대시보드 W1 데이터 기록
[ ] 5.8 발행 품질 검수 (렌더링 육안 확인)
[ ] 5.9 레거시 코드 완전 폐기

[Phase 6: 콘텐츠 누적 + SEO]
[ ] 6.1 주 3~5건 안정 발행 확인
[ ] 6.2 프롬프트 튜닝 (통과율 85%+)
[ ] 6.3 내부 링크 구조 강화 (허브-스포크)
