"""extract_first_image_url() 단위 테스트."""
from src.infrastructure.browser.html_transformer import extract_first_image_url
...
class TestExtractFirstImageUrl:
    ...
    def test_basic_img_extraction(self):
        ...
        assert extract_first_image_url(html) == "https://example.com/photo.jpg"
    ...
    def test_returns_first_of_multiple_images(self):
        ...
        assert extract_first_image_url(html) == "https://first.com/a.png"
    ...
    def test_skips_data_uri(self):
        ...
        assert extract_first_image_url(html) == "https://real.com/img.jpg"
    ...
    def test_skips_relative_path(self):
        ...
        assert extract_first_image_url(html) == "https://cdn.example.com/pic.webp"

    def test_no_images_returns_empty(self):
        html = "<p>No images here</p><div>Just text</div>"
        assert extract_first_image_url(html) == ""

    def test_empty_html_returns_empty(self):
        assert extract_first_image_url("") == ""
    ...
    def test_single_quoted_src(self):
        ...
        assert extract_first_image_url(html) == "https://example.com/single.jpg"

    def test_src_with_preceding_attributes(self):
        html = '<img class="thumb" alt="photo" src="https://example.com/attr.jpg">'
        assert extract_first_image_url(html) == "https://example.com/attr.jpg"
